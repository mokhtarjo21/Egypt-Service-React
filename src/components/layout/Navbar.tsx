...
export const Navbar: React.FC = () => {
  ...
  const userMenuItems = isAuthenticated ? [
    ...
    { href: '/add-service', label: 'إضافة خدمة', icon: Plus },
    ...
    ...(user?.role === 'admin' ? [{ href: '/admin', label: 'لوحة الإدارة', icon: Shield }] : []),
  ] : [];
    ...
    <>
            ...
            <div className="hidden lg:flex flex-1 max-w-lg mx-8">
              <div className="relative w-full">
                ...
                <input
                  ...
                  className={`w-full ${isRTL ? 'pr-10 pl-4' : 'pl-10 pr-4'} py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent`}
                    ...
                    <div className={`absolute top-full mt-2 w-64 bg-white rounded-lg shadow-lg border border-gray-200 py-2 ${isRTL ? 'left-0' : 'right-0'}`}>
                      ...
                      {userMenuItems.map((item) => {
                        ...
                        return (
                          ...
                          >
                            {Icon && <Icon className="w-4 h-4 mr-3 rtl:mr-0 rtl:ml-3" />}
                            {item.label}
                          </Link>
                        );
                      })}
      ...
      {mobileMenuOpen && (
        <div className="fixed inset-0 z-50 lg:hidden">
          ...
          {/* Sidebar */}
          <div className={`fixed top-0 ${isRTL ? 'right-0' : 'left-0'} h-full w-80 bg-white shadow-xl transform transition-transform`}>
            {/* Sidebar Header */}
                ...
                {navigationItems.map((item) => {
                  ...
                  return (
                    <Link
                      ...
                      onClick={() => dispatch(setMobileMenuOpen(false))}
                    >
                      {Icon && <Icon className="w-5 h-5 mr-3 rtl:mr-0 rtl:ml-3" />}
                      {item.label}
                    </Link>
                  );
                })}
