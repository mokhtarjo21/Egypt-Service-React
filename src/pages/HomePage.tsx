...
const HomePage: React.FC = () => {
  ...
  const { categories, featuredServices } = useSelector(
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="bg-gradient-to-r from-primary-700 to-secondary-700 text-white py-20 relative overflow-hidden">
                ...
                <div className="aspect-w-16 aspect-h-10">
                  <img
                    src={
                      ...
                      "https://images.pexels.com/photos/8985471/pexels-photo-8985471.jpeg?auto=compress&cs=tinysrgb&w=400"
                    }
                    alt={
                      isRTL
                        ? service.title_ar
            ...
            {features.map((feature, index) => {
              ...
              return (
                <Card key={index} className="text-center">
                  <div className="mb-6">
                    <div className="inline-flex p-4 rounded-full bg-gradient-to-tr from-primary-500 to-secondary-500 mx-auto">
